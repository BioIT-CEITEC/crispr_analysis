...
rule DE_genes_MAGeCK:
    ...
    params: prefix = "DE_results/MAGeCK/{c1}_vs_{c2}/{c1}_vs_{c2}",
            ...
            script = workflow.basedir+"/wrappers/DE_genes_MAGeCK/process_mageck_results.R",
            gene = "DE_results/MAGeCK/{c1}_vs_{c2}/{c1}_vs_{c2}.gene_summary.txt",
            gene_neg = "DE_results/MAGeCK/{c1}_vs_{c2}/{c1}_vs_{c2}.gene_summary.neg_rank.tsv",
            gene_pos = "DE_results/MAGeCK/{c1}_vs_{c2}/{c1}_vs_{c2}.gene_summary.pos_rank.tsv",
